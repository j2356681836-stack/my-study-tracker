...
<style>
    ...
    [data-testid="stVerticalBlockBorderWrapper"], [data-testid="stHeader"],[data-testid="stMarkdownContainer"] {{
    ...
    /* Radio Buttons (Time Filter) & Alignment */[data-testid="stRadio"] > div {{ display: flex; justify-content: flex-end; }}
